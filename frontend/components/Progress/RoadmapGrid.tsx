...
export default function RoadmapGrid({ roadmaps, onSelect }: RoadmapGridProps) {
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {roadmaps.map((roadmap) => (
        <div
          ...
          className={`p-6 rounded-lg border cursor-pointer transition-all hover:shadow-md ${getStatusColor(roadmap.status)}`}
        >
